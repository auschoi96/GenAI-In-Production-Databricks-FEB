...
# MAGIC %pip install -U --quiet databricks-sdk databricks-agents mlflow-skinny mlflow mlflow[gateway] mlflow[databricks] databricks-vectorsearch langchain langchain_core langchain_community databricks-langchain
